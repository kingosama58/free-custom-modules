...
class FollowupLine(models.Model):
    ...
    def default_get(self, default_fields):
        ...
        if self.env.ref('at_account_followup.email_template_at_account_followup_default'):
            values['email_template_id'] = self.env.ref('at_account_followup.email_template_at_account_followup_default').id
        return values
